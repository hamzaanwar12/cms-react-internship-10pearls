...
const Sidebar: React.FC = () => {
  ...
  const userCurrState: UserState = useSelector((state: RootState) => state.userState);
  const sideBarItems = userCurrState.user?.role == "ADMIN" ? sideBarAdminItems : sideBarUserItems
  ...
  return (
    <aside className="hidden md:flex md:flex-col sticky  top-0 left-0  bg-dark-1 px-1 lg:px-2  w-fit py-6 gap-3 sm:items-center sm:min-w-[65px] lg:items-start sm:max-w-[90px] lg:max-w-[250px] max-h-screen max-sm:hidden">
